...
>
    ...
    <FeatureItem title="Contribute Informally" icon="tabler:lock-open" iconClass="bg-green-400">
        If you’re not available for a formal position but would like to contribute, <span class="text-green-800 dark:text-green-600 font-bold">[click here](https://use.qiime2.org/en/latest/how-to-guides/get-involved.html)</span> to read Greg's article about how to get involved in the community.
...
>
    ...
    <FeatureItem title="How to Apply" icon="tabler:list-check" iconClass="bg-green-600">
        ...
        Email <span class="text-green-800 dark:text-green-600 font-bold">[cap-lab@nau.edu](mailto:cap-lab@nau.edu)</span> and let us know what you're interested in working on, and we'll let you know if we have a position available. For general application information and job requirements at Northern Arizona University, <span class="text-green-800 dark:text-green-600 font-bold">[click here](https://in.nau.edu/pmi/pathogen-microbiome-institute/undergraduate-employment-opportunities/)</span>.
    </FeatureItem>
</Features>
