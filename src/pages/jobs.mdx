...
>
    ...
    <FeatureItem title="Contribute Informally" icon="tabler:lock-open" iconClass="bg-green-400">
        If you’re not available for a formal position but would like to contribute, <span class="text-green-800 dark:text-green-600 font-bold">[click here](https://use.qiime2.org/en/stable/how-to-guides/get-involved.html)</span> to read Greg's article about how to get involved in the community.
